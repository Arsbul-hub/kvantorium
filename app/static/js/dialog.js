...
function open_confirm(id) {
    document.getElementById(String.format('confirm-dialog-{0}', id)).style.visibility = "visible"
...
function close_confirm(id) {
    document.getElementById(String.format('confirm-dialog-{0}', id)).style.visibility = "hidden"
